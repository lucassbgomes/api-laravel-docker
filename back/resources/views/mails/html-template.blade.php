@php
  $img_header = asset('img/laravel.png');
@endphp
...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <head>
    ...
    <!-- <link rel="stylesheet" href="{{asset('css/foundation-emails.min.css')}}"> -->
    <style>
                            ...
                            <tbody>
                              <tr>
                                <th class="small-6 large-6 columns first">
                                  <table>
                                    <tr>
                                      <th> <img src="{{$img_header}}"> </th>
                                    </tr>
                                  </table>
                                </th>
                                <th class="small-6 large-6 columns last"></th>
                              </tr>
                            </tbody>
                          </table>
                        </td>
                            ...
                            <tbody>
                              <tr>
                                <th class="small-12 large-12 columns first">
                                  <table>
                                    <tr>
                                      <th style="font-size:11px;line-height:16px; color:#555">
                                        <strong>&copy; {{config('site.title').config('site.posfix')}} 2018</strong>
                                        <br/>
                                        {{config('site.client.full_address')}}
                                        <br/>
                                        {{config('site.client.phone')}} | {{config('site.client.mobile')}} 
                                      </th>
                                    </tr>
                                  </table>
                                </th>
